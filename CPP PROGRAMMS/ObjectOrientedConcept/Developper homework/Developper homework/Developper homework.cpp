...
public:
    clsDevelopper(int ID, string FirstName, string LastName, string Email, string Phone, string Title, string Department, float Salary, string ProgrammingLanguage)
...

{
    ...
    clsDevelopper Developper1(10, "Mohammed", "Abu-Hadhoud", "A@a.com", "8298982", "CEO", "ProgrammingAdvices", 5000,"C++");
    Developper1.Print();
