...
bool areequal(int matrix1[3][3], int matrix2[3][3], int nrows, int ncolomns)
{
	return (sumofelemnts(matrix1, nrows, ncolomns) == sumofelemnts(matrix2, nrows, ncolomns));
}
int main()
{
	...
	if (areequal(matrix1,matrix2, nrows, ncolomns))
	{
